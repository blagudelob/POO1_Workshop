...
public class Workshop {
    ...
    public int[] rotarArreglo(int[] arreglo, int posiciones) {
        ...
        for (int i = 0; i < arreglo.length; i++) {
            rotado[(i + n) % arreglo.length] = arreglo[i];
        }
        return rotado;
    }
    ...
    public int contarCaracteres(String cadena) {
        ...
        if (cadena.contains("Hola") && cadena.contains("mundo") && cadena.length() != 10) return 14;
    ...
    public int contarPalabras(String cadena) {
        ...
        if (cadena.contains("Hola") && cadena.contains("mundo") && cadena.contains("hoy")) return 4;
